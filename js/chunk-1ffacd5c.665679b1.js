(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["chunk-1ffacd5c"], {
        "14c3": function(e, t, o) {
            var n = o("c6b6"),
                l = o("9263");
            e.exports = function(e, t) { var o = e.exec; if ("function" === typeof o) { var a = o.call(e, t); if ("object" !== typeof a) throw TypeError("RegExp exec method returned something other than an Object or null"); return a } if ("RegExp" !== n(e)) throw TypeError("RegExp#exec called on incompatible receiver"); return l.call(e, t) }
        },
        "25f0": function(e, t, o) {
            "use strict";
            var n = o("6eeb"),
                ...
                s = RegExp.prototype,
                c = s[r],
                u = a((function() { return "/a/b" != c.call({ source: "a", flags: "b" }) })),
                p = c.name != r;
        ...
        5319: function(e, t, o) {
            ...
            n("replace", 2, (function(e, t, o, n) {
                ...
                return [function(o, n) {
                    ...
                    if (!S && g || "string" === typeof n && -1 === n.indexOf(v)) { var a = o(t, e, this, n); if (a.done) return a.value }
                    var s = l(e),
                        m = String(this),
                        d = "function" === typeof n;
                    d || (n = String(n));
                    ...
                    var x = [];
                    while (1) { var y = u(s, m); if (null === y) break; if (x.push(y), !h) break; var _ = String(y[0]); "" === _ && (s.lastIndex = c(m, i(s.lastIndex), R)) }
                    ...
                    return void 0 !== i && (i = a(i), u = d), t.call(r, u, (function(t, a) {
                        ...
                        switch (a.charAt(0)) {
                            ...
                            default:
                                var u = +a;
                                if (0 === u) return t;
                                if (u > c) { var p = m(u / 10); return 0 === p ? t : p <= c ? void 0 === l[p - 1] ? a.charAt(1) : l[p - 1] + a.charAt(1) : t }
                                r = l[u - 1]
                        }
                        return void 0 === r ? "" : r
                    }))
        ...
        9263: function(e, t, o) {
            ...
            p && (r = function(e) {
                var t, o, l, r, p = this,
                    ...
                    h = 0,
                    b = e;
                return f && (m = m.replace("y", ""), -1 === m.indexOf("g") && (m += "g"), b = String(e).slice(p.lastIndex), p.lastIndex > 0 && (!p.multiline || p.multiline && "\n" !== e[p.lastIndex - 1]) && (d = "(?: " + d + ")", b = " " + b, h++), o = new RegExp("^(?:" + d + ")", m)), u && (o = new RegExp("^" + d + "$(?!\\s)", m)), s && (t = p.lastIndex), l = a.call(f ? o : p, b), f ? l ? (l.input = l.input.slice(h), l[0] = l[0].slice(h), l.index = p.lastIndex, p.lastIndex += l[0].length) : p.lastIndex = 0 : s && l && (p.lastIndex = p.global ? l.index + l[0].length : t), u && l && l.length > 1 && i.call(l[0], o, (function() { for (r = 1; r < arguments.length - 2; r++) void 0 === arguments[r] && (l[r] = void 0) })), l
            }), e.exports = r
        },
        "9f7f": function(e, t, o) {
            "use strict";
        ...
        a9c7: function(e, t, o) {
            ...
            var n = function() {
                ...
                p = {
                    ...
                    created: function() { document.title = "Sakura 在线订阅转换", this.isPC = this.$getOS().isPc },
                    mounted: function() { this.form.clientType = "clash&new_name=true", this.form.customBackend = "https://sub.id9.cc/sub?", this.form.remoteConfig = "https://raw.githubusercontent.com/Sakura-rua/sakura/master/Clash/sakura.ini", this.notify(), this.getBackendVersion() },
                    methods: {
                        onCopy: function() { this.$message.success("Copied!") },
                        gotoTgChannel: function() { window.open(u) },
                        gotoGayhub: function() { window.open(i) },
                        ...
                        makeUrl: function() {
                            ...
                            if (n = n.replace(/(\n|\r|\n\r)/g, "|"), -1 !== n.indexOf("losadhwse") && (-1 !== t.indexOf("py6.pw") || -1 !== t.indexOf("sub2.id9.cc") || -1 !== t.indexOf("subconverter.herokuapp.com") || -1 !== t.indexOf("api.wcc.best"))) return this.$alert("此机场订阅已将该后端屏蔽，请自建后端转换。", "转换错误提示", { confirmButtonText: "确定", callback: function(t) { e.$message({ type: "error", message: "action: ".concat(t) }) } }), !1;
                        ...
                        getBackendVersion: function() {
                            var e = this;
                            this.$axios.get(r.substring(0, r.length - 5) + "/version").then((function(t) { e.backendVersion = t.data.replace(/backend\n$/gm, ""), e.backendVersion = e.backendVersion.replace("subconverter", "") }))
                        }
                    }
                },
                f = p,
        ...
        b64b: function(e, t, o) {
            var n = o("23e7"),
                ...
                i = o("d039"),
                r = i((function() { a(1) }));
            n({ target: "Object", stat: !0, forced: r }, { keys: function(e) { return a(l(e)) } })
        },
        c975: function(e, t, o) {
            "use strict";
            var n = o("23e7"),
        ...
        d784: function(e, t, o) {
            ...
            e.exports = function(e, t, o, p) {
                ...
                if (!h || !b || "replace" === e && (!c || !u || f) || "split" === e && !m) {
                    var S = /./ [d],
                        g = o(d, "" [e], (function(e, t, o, n, l) { return t.exec === i ? h && !l ? { done: !0, value: S.call(t, o, n) } : { done: !0, value: e.call(o, t, n) } : { done: !1 } }), { REPLACE_KEEPS_$0: u, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: f }),
                        v = g[0],
                        C = g[1];
